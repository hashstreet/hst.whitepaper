...
为了促进生态各方对哈希街模式的认可，哈希街首创了消费积分可以自动实对冲生活付费的模式。消费者在日常生活中除了消费以外，还需要支付各种需要定期支付的费用像物业费、停车费等。通过和物业管理公司的合作，居民在本地商圈产生的消费积分可以直接用来对冲居民所需要支付的定期物业费和停车费等。因此物业公司解决了收取费用难的问题，同时居民消费者通过必要的消费还降低了生活成本。这种共赢的模式必将被社区所广泛接受。

## 三、具体流程介绍

1. `V`权益积分生成

`V`权益积分具有参与全平台内商家返佣分红和治理等权益，相当于在平台的股份权益。每一个新`V`的生成都是在新用户（个人消费者或者商家代表用户）完成注册时候产生，并且按照以下情况分配这`1 V`:

根据注册用户有无邀请人或者推荐人的两种情况对新生成的`1 V`进行如下分配：

- Case-1: 有邀请人

|邀请人   |平台     |用户实名 |团队     |
|--------|--------|--------|--------| 
|`0.2 V` |`0.5 V` |`0.25 V`|`0.05 V`|
